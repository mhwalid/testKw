                ...
                @endphp
      <form  action="{{ route('filter' ,$res[0])  }}" method="POST" class="form-inline mb-0 pb-0" >
        @csrf
                      ...
                      {{-- 5 --}}
                        ...
                        <li >  <div id="rond" style="border-radius: 200px;  right:19%;"  class="card my-0" >
                            <div  class="card-header"  id="headingSix">
                              <h5  class="mb-0">
                                <button id="FilterBoutton"  class="btn btn-link collapsed"type="button" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                        ...
                        @if(count($sock_proc)>1)
                          <li >  <div id="rond" style="border-radius: 200px;  right:19%;"  class="card my-0" >
                            <div  class="card-header"  id="headingSeven">
                              <h5  class="mb-0">
                                <button id="FilterBoutton"  class="btn btn-link collapsed"  type="button" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
