...
<div class="container-fluid">
    ...
    <div class=" col-md-8 col-10 ml-lg-5 ">
                ...
                <div class="row justify-content-between text-left">
                        <div class="form-group col-12 flex-column d-flex"> <label class="form-control-label ">Société<span class="text-danger"> </span></label> <input type="text" id="log1" name="ans" placeholder="Nom de votre société"  @auth value="{{ Auth::user()->Customer->Name }}" @endauth onblur="validate(6)"> </div>
                    </div>
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label ">Nom<span class="text-danger"> </span></label> <input type="text" id="log1" name="fname" placeholder="Votre nom" @auth value="{{ Auth::user()->name }}" @endauth onblur="validate(1)"> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label ">Prénom<span class="text-danger"> </span></label> <input type="text" id="log1" name="lname" placeholder="Votre prénom" @auth value="{{ Auth::user()->first_name }}" @endauth onblur="validate(2)"> </div>
                    </div>
                    <div class="row justify-content-between text-left">
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label ">Adresse e-mail<span class="text-danger"> </span></label> <input type="text" id="log1" name="email" placeholder="Votre e-mail" @auth value="{{ Auth::user()->email }}" @endauth onblur="validate(3)"> </div>
                        <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label ">Numéro de téléphone<span class="d-inline-flex" style="color: #898281; font-size: 13px;"><p style="padding-right: 5px; padding-left: 2px; margin-bottom: 0px;"> *</p>(Optionnel)</span></label> <input type="text" id="log1" name="mob" placeholder="Votre numéro de téléphone" @auth value="{{ Auth::user()->phone }}" @endauth onblur="validate(4)"> </div>
                    </div>
                    <div class="row justify-content-between text-left">
