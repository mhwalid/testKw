                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <div class="p-2">
                                                ...
                                                <h6 class="mb-0"> <a href="{{ route('product.show',$item->id)}}" class="text-dark d-inline-block align-middle">{{$item->name}}</a></h6>
                                            ...
                                            <td class="border-0 align-middle"> <select class="custom-select" name="qty" id="qty" data-id="{{ $item->rowId }}" data-stock="{{ intval($item->model->RealStock) }}">
                                                @for ($i = 1; $i <= 25; $i++)
