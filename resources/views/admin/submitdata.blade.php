@php
    ...
    $i=1;
    $j=0;
    // array_map('unlink', glob("asset/item/images/".$iditem."/*"));
    // dd($_POST['iditem']);
    // dd(is_dir("asset/item/images/".$iditem));
    if (!is_dir("asset/item/images/$iditem")) {
    ...
    if($_FILES['manualadd_images']['name'][0] != ""){
...
@section('content')
    <a href="{{ route('admin.dashboard') }} ">retour accueil</a>
